...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section1_entropy', feature_count=3)
...
print("="*80)
print("SECTION 2: POI COUNTS & DENSITIES")
print("="*80)
print()
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section2_poi_features', feature_count=64)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section3_indonesia', feature_count=36)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section4_competition', feature_count=3)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section5_demographics', feature_count=3)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section6_accessibility', feature_count=3)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section7_interactions', feature_count=6)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section8_indonesia_advanced', feature_count=4)
...
# SAVE CHECKPOINT
save_checkpoint(df_mature, 'section9_temporal', feature_count=5)
